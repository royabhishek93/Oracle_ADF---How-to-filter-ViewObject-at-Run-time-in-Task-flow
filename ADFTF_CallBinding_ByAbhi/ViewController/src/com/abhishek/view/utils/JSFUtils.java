package com.abhishek.view.utils;
...
public class JSFUtils {
     ...
     * @return Faces Message object
     */
    public static FacesMessage getMessageFromResourceBundle(String key, FacesMessage.Severity severity) {
        FacesMessage fm = new FacesMessage();
        String msgText =
            (String)JSFUtils.resolveExpression("#{adfBundle['za.its.integrator.common.model.IntegratorBundle']." +
                                               key + "}");
        fm.setSummary(msgText);
        fm.setDetail(msgText);
    ...
    /**
     * Add JSF error message for a specific attribute.
     * @param bundleCode error message code in the resource bundle
     */
    public static void addFacesBundleErrorMessage(String bundleCode) {
        FacesContext ctx = FacesContext.getCurrentInstance();
        FacesMessage fm = new FacesMessage();
        fm = getMessageFromResourceBundle(bundleCode, FacesMessage.SEVERITY_ERROR);
        ctx.addMessage(getRootViewComponentId(), fm);
     ...
     * @param bundleCode error message code in the resource bundle
     */
    public static void addFacesBundleWarningMessage(String bundleCode) {
        FacesContext ctx = FacesContext.getCurrentInstance();
        FacesMessage fm = new FacesMessage();
        fm = getMessageFromResourceBundle(bundleCode, FacesMessage.SEVERITY_WARN);
        ctx.addMessage(getRootViewComponentId(), fm);
    }
    ...
    */
    ...
    public static void resetLocale(Locale locale) {
        ...
        if (locale != null && !locale.equals(uiViewRoot.getLocale())) {
